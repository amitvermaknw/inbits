...
export async function generateMetadata(): Promise<Metadata> {
    const result: { msg: Array<Article> | string, status: number } = await fetchArticleByCategory("entertainment", new Date());
    ...
    return {
        ...
        openGraph: {
            ...
            url: result.msg?.length && typeof result.msg === 'object' ? result.msg[0].url : `${APP_BASE_URL}/entertainment`,
        },
        twitter: {
        ...
        alternates: {
            canonical: result.msg?.length && typeof result.msg === 'object' ? result.msg[0].url : `${APP_BASE_URL}/entertainment`
        }
    };
}
